public class MultiSetPermutation {
    ...
    public MultiSetPermutation(String word) {
        ...
        this.wordInLetters = new char[this.word.trim().length()];
        this.wordInLetters = this.word.toLowerCase().trim().toCharArray();
        this.maxNumberOfPermutation = 0;

    }

    public char[] getWordInLetters() {
        return wordInLetters;
    }

    public void setWordInLetters(char[] wordInLetters) {
